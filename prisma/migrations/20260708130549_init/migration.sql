...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('bank', 'cash_on_delivery');
...
-- CreateIndex
CREATE UNIQUE INDEX "cart_items_user_id_product_id_color_size_key" ON "cart_items"("user_id", "product_id", "color", "size");
